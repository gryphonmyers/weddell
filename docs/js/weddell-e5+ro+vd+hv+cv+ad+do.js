...
},{"../utils/includes":78,"../utils/make-hash":79,"./event-emitter-mixin":56,"./sig":58,"mixwith-es5":21,"object.defaults/immutable":23}],56:[function(require,module,exports){
...
},{"../utils/includes":78,"mixwith-es5":21,"object.defaults/immutable":23}],57:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"../utils/difference":76,"../utils/includes":78,"../utils/make-hash":79,"./event-emitter-mixin":56,"deep-equal":7,"mixwith-es5":21,"object.defaults/immutable":23}],60:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":78,"./app":54,"./component":55,"./pipeline":57,"./sig":58,"./store":59,"./transform":60,"mixwith-es5":21}],62:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
...
},{"../../core/event-emitter-mixin":56,"mixwith-es5":21}],71:[function(require,module,exports){
var defaults = require('object.defaults/immutable');
...
},{"../../core/event-emitter-mixin":56,"./machine-state-mixin":70,"mixwith-es5":21}],73:[function(require,module,exports){
...
},{"../plugins/action-dispatcher":63,"../plugins/css-vars":65,"../plugins/doT":66,"../plugins/html-to-vdom":68,"../plugins/router":69,"../plugins/vdom":73,"./weddell":75,"native-promise-only":22}],75:[function(require,module,exports){
module.exports = require('../core/weddell');

},{"../core/weddell":61}],76:[function(require,module,exports){
