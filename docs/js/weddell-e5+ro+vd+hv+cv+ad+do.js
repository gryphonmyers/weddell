...
},{"../utils/difference":75,"../utils/includes":77,"../utils/make-hash":78,"./event-emitter-mixin":55,"deep-equal":6,"mixwith-es5":20,"object.defaults/immutable":22}],59:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"prescribe":26}],67:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
...
},{"find-parent":12,"object.defaults/immutable":22,"path-to-regexp":24}],71:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../../utils/flatmap":76,"mixwith-es5":20,"object.defaults/immutable":22,"virtual-dom/diff":27,"virtual-dom/h":28,"virtual-dom/patch":29,"virtual-dom/vnode/vnode":47}],73:[function(require,module,exports){
...
},{"../plugins/action-dispatcher":62,"../plugins/css-vars":64,"../plugins/doT":65,"../plugins/html-to-vdom":67,"../plugins/router":68,"../plugins/vdom":72,"./weddell":74,"native-promise-only":21}],74:[function(require,module,exports){
