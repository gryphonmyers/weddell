...
},{"./mutable":19,"array-slice":3}],19:[function(require,module,exports){
'use strict';
...
},{"array-each":2,"array-slice":3,"for-own":15,"isobject":16}],20:[function(require,module,exports){
...
},{"./event-emitter-mixin":25,"mixwith-es5":17}],23:[function(require,module,exports){
...
},{"./action-dispatcher":22,"./component":24,"./event-emitter-mixin":25,"./sig":27,"debounce":5,"document-ready-promise":12,"mixwith-es5":17,"object.defaults/immutable":18}],24:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var defaults = require('object.defaults/immutable');
...
},{"../utils/includes":38,"../utils/make-hash":39,"./event-emitter-mixin":25,"./sig":27,"mixwith-es5":17,"object.defaults/immutable":18}],25:[function(require,module,exports){
...
},{"../utils/includes":38,"mixwith-es5":17}],26:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"./event-emitter-mixin":25,"mixwith-es5":17}],27:[function(require,module,exports){
class Sig {
    constructor(str) {
...
},{"../utils/difference":37,"../utils/includes":38,"../utils/make-hash":39,"./event-emitter-mixin":25,"array-uniq":4,"deep-equal":6,"mixwith-es5":17,"object.defaults/immutable":18}],29:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":38,"./app":23,"./component":24,"./pipeline":26,"./sig":27,"./store":28,"./transform":29,"mixwith-es5":17}],31:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var mix = require('mixwith-es5').mix;
...
},{"./machine-state-mixin":32,"./router":33,"./state-machine-mixin":34,"defaults-es6/deep-merge":9,"mixwith-es5":17}],32:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
...
},{"../../core/event-emitter-mixin":25,"mixwith-es5":17}],33:[function(require,module,exports){
var defaults = require('object.defaults/immutable');
...
},{"array-compact":1,"find-parent":13,"object.defaults/immutable":18,"path-to-regexp":20}],34:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../../core/event-emitter-mixin":25,"./machine-state-mixin":32,"mixwith-es5":17}],35:[function(require,module,exports){
module.exports = require('../plugins/router')(require('./weddell'));

},{"../plugins/router":31,"./weddell":36}],36:[function(require,module,exports){
module.exports = require('../core/weddell');

},{"../core/weddell":30}],37:[function(require,module,exports){
