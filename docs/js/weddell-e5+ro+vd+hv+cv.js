...
},{"../utils/make-hash":75,"./event-emitter-mixin":56,"./sig":58,"array-compact":1,"array-uniq":4,"mixwith-es5":20,"object.defaults/immutable":22}],56:[function(require,module,exports){
...
},{"../utils/includes":74,"mixwith-es5":20,"object.defaults/immutable":22}],57:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"../utils/difference":73,"../utils/includes":74,"../utils/make-hash":75,"./event-emitter-mixin":56,"deep-equal":8,"mixwith-es5":20,"object.defaults/immutable":22}],60:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":74,"./app":54,"./component":55,"./pipeline":57,"./sig":58,"./store":59,"./transform":60,"mixwith-es5":20}],62:[function(require,module,exports){
module.exports = {
...
},{"../../core/event-emitter-mixin":56,"mixwith-es5":20}],68:[function(require,module,exports){
var defaults = require('object.defaults/immutable');
...
},{"find-parent":13,"object.defaults/immutable":22,"path-to-regexp":25}],69:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../../core/event-emitter-mixin":56,"./machine-state-mixin":67,"mixwith-es5":20}],70:[function(require,module,exports){
...
},{"mixwith-es5":20,"object.defaults/immutable":22,"virtual-dom/diff":28,"virtual-dom/h":29,"virtual-dom/patch":30,"virtual-dom/vnode/vnode":48}],71:[function(require,module,exports){
...
},{"../plugins/css-vars":63,"../plugins/html-to-vdom":65,"../plugins/router":66,"../plugins/vdom":70,"./weddell":72,"native-promise-only":21}],72:[function(require,module,exports){
...
},{"./includes":74}],74:[function(require,module,exports){
