...
module.exports = function (h, html, wrap) {
    ...
    parser.readTokens({
        ...
        endTag: function endTag(tok) {
            ...
            if (current.children.every(function (child) {
                return typeof child === 'string';
            })) {
                props.innerHTML = current.children.reduce(function (final, child) {
                    return final + child;
                }, '');
                current.children = [];
            }
...
},{"prescribe":25}],14:[function(require,module,exports){
'use strict';
...
},{"./mutable":17,"array-slice":19}],17:[function(require,module,exports){
'use strict';
...
},{"array-each":18,"array-slice":19,"for-own":21,"isobject":22}],18:[function(require,module,exports){
/*!
...
},{"for-in":20}],22:[function(require,module,exports){
/*!
...
},{"./vtree/diff.js":61}],28:[function(require,module,exports){
"use strict";
...
},{"individual/one-version":33}],31:[function(require,module,exports){
(function (global){
'use strict';
...
},{"min-document":3}],32:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../vnode/is-vhook.js":52,"is-object":34}],38:[function(require,module,exports){
"use strict";
...
},{"../vnode/handle-thunk.js":50,"../vnode/is-vnode.js":53,"../vnode/is-vtext.js":54,"../vnode/is-widget.js":55,"./apply-properties":37,"global/document":31}],39:[function(require,module,exports){
"use strict";
...
},{"../vnode/is-widget.js":55,"../vnode/vpatch.js":58,"./apply-properties":37,"./update-widget":42}],41:[function(require,module,exports){
"use strict";
...
},{"./create-element":38,"./dom-index":39,"./patch-op":40,"global/document":31,"x-is-array":35}],42:[function(require,module,exports){
"use strict";
...
},{"../vnode/is-widget.js":55}],43:[function(require,module,exports){
'use strict';
...
},{"ev-store":30}],45:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-thunk":51,"../vnode/is-vhook":52,"../vnode/is-vnode":53,"../vnode/is-vtext":54,"../vnode/is-widget":55,"../vnode/vnode.js":57,"../vnode/vtext.js":59,"./hooks/ev-hook.js":44,"./hooks/soft-set-hook.js":45,"./parse-tag.js":47,"x-is-array":35}],47:[function(require,module,exports){
'use strict';
...
},{"browser-split":29}],48:[function(require,module,exports){
'use strict';
...
},{"./hooks/attribute-hook":43,"./index.js":46,"./svg-attribute-namespace":48,"x-is-array":35}],50:[function(require,module,exports){
"use strict";
...
},{"../vnode/is-vhook":52,"is-object":34}],61:[function(require,module,exports){
"use strict";
...
},{"../vnode/handle-thunk":50,"../vnode/is-thunk":51,"../vnode/is-vnode":53,"../vnode/is-vtext":54,"../vnode/is-widget":55,"../vnode/vpatch":58,"./diff-props":60,"x-is-array":35}],62:[function(require,module,exports){
'use strict';
...
},{"./event-emitter-mixin":64,"./vdom-widget":66,"document-ready-promise":10,"mixwith-es5":14,"object.defaults/immutable":16,"virtual-dom/create-element":26,"virtual-dom/diff":27,"virtual-dom/h":28,"virtual-dom/patch":36}],63:[function(require,module,exports){
'use strict';
...
},{"../utils/make-hash":81,"./event-emitter-mixin":64,"./vdom-widget":66,"mixwith-es5":14,"object.defaults/immutable":16,"virtual-dom/h":28}],64:[function(require,module,exports){
'use strict';
...
},{"../utils/includes":80,"mixwith-es5":14}],65:[function(require,module,exports){
'use strict';
...
},{"../utils/difference":78,"../utils/includes":80,"./event-emitter-mixin":64,"array-uniq":2,"deep-equal":4,"mixwith-es5":14,"object.defaults/immutable":16}],66:[function(require,module,exports){
'use strict';
...
},{"virtual-dom/create-element":26,"virtual-dom/diff":27,"virtual-dom/h":28,"virtual-dom/patch":36,"virtual-dom/virtual-hyperscript/svg":49}],67:[function(require,module,exports){
'use strict';
...
},{"./app":62,"./component":63,"./store":65,"mixwith-es5":14}],68:[function(require,module,exports){
'use strict';
...
},{"dot":11,"mixwith-es5":14}],69:[function(require,module,exports){
'use strict';
...
},{"mixwith-es5":14,"object.defaults/immutable":16}],70:[function(require,module,exports){
'use strict';
            ...
            App: Mixin(function (_App) {
                _App = function (_App2) {
                    ...
                    function App(opts) {
                        ...
                        var Transform = _this.constructor.Weddell.classes.Transform;
                        var h = _this.constructor.Weddell.deps.h;
...
},{"html-to-vdom-parser/parse":13,"mixwith-es5":14}],71:[function(require,module,exports){
'use strict';
...
},{"./machine-state-mixin":72,"./router":73,"./state-machine-mixin":74,"defaults-es6/deep-merge":7,"mixwith-es5":14}],72:[function(require,module,exports){
'use strict';
...
},{"../../core/event-emitter-mixin":64,"mixwith-es5":14}],73:[function(require,module,exports){
'use strict';
...
},{"array-compact":1,"find-parent":12,"object.defaults/immutable":16,"path-to-regexp":23}],74:[function(require,module,exports){
'use strict';
...
},{"../../core/event-emitter-mixin":64,"./machine-state-mixin":72,"mixwith-es5":14}],75:[function(require,module,exports){
'use strict';
            ...
            App: Mixin(function (App) {
                return function (_App) {
                    ...
                    function _class(opts) {
                        ...
                        _this2.vTree = h('div');
                        _this2.rootNode = createElement(_this2.vTree);
...
},{"../../utils/flatmap":79,"array-compact":1,"mixwith-es5":14,"object.defaults/immutable":16,"virtual-dom/create-element":26,"virtual-dom/diff":27,"virtual-dom/h":28,"virtual-dom/patch":36,"virtual-dom/virtual-hyperscript/svg":49,"virtual-dom/vnode/vnode":57}],76:[function(require,module,exports){
'use strict';
...
},{"../plugins/doT":68,"../plugins/fetcher":69,"../plugins/html-to-vdom":70,"../plugins/router":71,"../plugins/vdom":75,"./weddell":77,"native-promise-only":15}],77:[function(require,module,exports){
'use strict';

module.exports = require('../core/weddell');

},{"../core/weddell":67}],78:[function(require,module,exports){
"use strict";
