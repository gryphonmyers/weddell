...
},{"./mutable":21,"array-slice":2}],21:[function(require,module,exports){
'use strict';
...
},{"array-each":1,"array-slice":2,"for-own":13,"isobject":18}],22:[function(require,module,exports){
...
},{"../vnode/is-vhook.js":39,"is-object":17}],28:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":37,"../vnode/is-vnode.js":40,"../vnode/is-vtext.js":41,"../vnode/is-widget.js":42,"./apply-properties":27,"global/document":14}],29:[function(require,module,exports){
...
},{"./create-element":28,"./dom-index":29,"./patch-op":30,"global/document":14,"x-is-array":49}],32:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":10}],34:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":39,"is-object":17}],48:[function(require,module,exports){
var isArray = require("x-is-array")
...
},{"./event-emitter-mixin":52,"./sig":54,"debounce":5,"document-ready-promise":9,"mixwith-es5":19,"object.defaults/immutable":20}],51:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var defaults = require('object.defaults/immutable');
...
},{"../utils/includes":67,"../utils/make-hash":68,"./event-emitter-mixin":52,"./sig":54,"mixwith-es5":19,"object.defaults/immutable":20}],52:[function(require,module,exports){
...
},{"../utils/includes":67,"mixwith-es5":19,"object.defaults/immutable":20}],53:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"./event-emitter-mixin":52,"mixwith-es5":19}],54:[function(require,module,exports){
class Sig {
    constructor(str) {
...
},{"../utils/difference":65,"../utils/includes":67,"../utils/make-hash":68,"./event-emitter-mixin":52,"deep-equal":6,"mixwith-es5":19,"object.defaults/immutable":20}],56:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":67,"./app":50,"./component":51,"./pipeline":53,"./sig":54,"./store":55,"./transform":56,"mixwith-es5":19}],58:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var mix = require('mixwith-es5').mix;
...
},{"./machine-state-mixin":59,"./router":60,"./state-machine-mixin":61,"mixwith-es5":19}],59:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
...
},{"../../core/event-emitter-mixin":52,"mixwith-es5":19}],60:[function(require,module,exports){
var defaults = require('object.defaults/immutable');
...
},{"find-parent":11,"object.defaults/immutable":20,"path-to-regexp":22}],61:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../../core/event-emitter-mixin":52,"./machine-state-mixin":59,"mixwith-es5":19}],62:[function(require,module,exports){
...
},{"../../utils/flatmap":66,"mixwith-es5":19,"object.defaults/immutable":20,"virtual-dom/diff":24,"virtual-dom/h":25,"virtual-dom/patch":26,"virtual-dom/vnode/vnode":44}],63:[function(require,module,exports){
module.exports = require('../plugins/vdom')(
    require('../plugins/router')(require('./weddell'))
);

},{"../plugins/router":58,"../plugins/vdom":62,"./weddell":64}],64:[function(require,module,exports){
module.exports = require('../core/weddell');

},{"../core/weddell":57}],65:[function(require,module,exports){
