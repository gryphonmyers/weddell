...
},{"prescribe":24}],13:[function(require,module,exports){
'use strict';
...
},{"individual/one-version":32}],30:[function(require,module,exports){
(function (global){
'use strict';
...
},{"min-document":3}],31:[function(require,module,exports){
(function (global){
'use strict';
...
},{"../vnode/is-vhook.js":51,"is-object":33}],37:[function(require,module,exports){
"use strict";
...
},{"../vnode/handle-thunk.js":49,"../vnode/is-vnode.js":52,"../vnode/is-vtext.js":53,"../vnode/is-widget.js":54,"./apply-properties":36,"global/document":30}],38:[function(require,module,exports){
"use strict";
...
},{"./create-element":37,"./dom-index":38,"./patch-op":39,"global/document":30,"x-is-array":34}],41:[function(require,module,exports){
"use strict";
...
},{"ev-store":29}],44:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-thunk":50,"../vnode/is-vhook":51,"../vnode/is-vnode":52,"../vnode/is-vtext":53,"../vnode/is-widget":54,"../vnode/vnode.js":56,"../vnode/vtext.js":58,"./hooks/ev-hook.js":43,"./hooks/soft-set-hook.js":44,"./parse-tag.js":46,"x-is-array":34}],46:[function(require,module,exports){
'use strict';
...
},{"browser-split":28}],47:[function(require,module,exports){
'use strict';
...
},{"./hooks/attribute-hook":42,"./index.js":45,"./svg-attribute-namespace":47,"x-is-array":34}],49:[function(require,module,exports){
"use strict";
...
},{"../vnode/is-vhook":51,"is-object":33}],60:[function(require,module,exports){
"use strict";
...
},{"../vnode/handle-thunk":49,"../vnode/is-thunk":50,"../vnode/is-vnode":52,"../vnode/is-vtext":53,"../vnode/is-widget":54,"../vnode/vpatch":57,"./diff-props":59,"x-is-array":34}],61:[function(require,module,exports){
'use strict';
...
},{"./event-emitter-mixin":63,"./vdom-widget":65,"document-ready-promise":10,"mixwith-es5":13,"object.defaults/immutable":15,"virtual-dom/create-element":25,"virtual-dom/diff":26,"virtual-dom/h":27,"virtual-dom/patch":35}],62:[function(require,module,exports){
'use strict';
...
},{"../utils/make-hash":81,"./event-emitter-mixin":63,"./vdom-widget":65,"mixwith-es5":13,"object.defaults/immutable":15,"virtual-dom/h":27}],63:[function(require,module,exports){
'use strict';
...
},{"../utils/includes":80,"mixwith-es5":13}],64:[function(require,module,exports){
'use strict';
...
},{"../utils/difference":78,"../utils/includes":80,"./event-emitter-mixin":63,"array-uniq":2,"deep-equal":4,"mixwith-es5":13,"object.defaults/immutable":15}],65:[function(require,module,exports){
'use strict';
...
},{"virtual-dom/create-element":25,"virtual-dom/diff":26,"virtual-dom/h":27,"virtual-dom/patch":35,"virtual-dom/virtual-hyperscript/svg":48}],66:[function(require,module,exports){
'use strict';
...
},{"./app":61,"./component":62,"./store":64,"mixwith-es5":13}],67:[function(require,module,exports){
'use strict';

module.exports = {
    template: function template(CSSText) {
        ...
        return function (locals) {
            ...
            while (output.match(reg)) {
                output = output.replace(reg, function (fullMatch, group) {
                    return group.split(',').map(function (str) {
                        return str.trim();
                    }).map(function (val) {
            ...
            App: Mixin(function (_App) {
                _App = function (_App2) {
                    ...
                    function App(opts) {
                        ...
                        _this.stylesTransforms.push(new Transform({
                            from: 'CSSString',
...
},{"./css-vars":67,"mixwith-es5":13}],69:[function(require,module,exports){
'use strict';
...
},{"html-to-vdom-parser/parse":12,"mixwith-es5":13}],70:[function(require,module,exports){
'use strict';
...
},{"../../utils/includes":80,"mixwith-es5":13,"object.defaults/immutable":15,"prescribe":24}],71:[function(require,module,exports){
'use strict';
...
},{"./machine-state-mixin":72,"./router":73,"./state-machine-mixin":74,"defaults-es6/deep-merge":7,"mixwith-es5":13}],72:[function(require,module,exports){
'use strict';
...
},{"../../core/event-emitter-mixin":63,"mixwith-es5":13}],73:[function(require,module,exports){
'use strict';
...
},{"array-compact":1,"find-parent":11,"object.defaults/immutable":15,"path-to-regexp":22}],74:[function(require,module,exports){
'use strict';
...
},{"../../core/event-emitter-mixin":63,"./machine-state-mixin":72,"mixwith-es5":13}],75:[function(require,module,exports){
'use strict';
...
},{"../../utils/flatmap":79,"array-compact":1,"mixwith-es5":13,"object.defaults/immutable":15,"virtual-dom/create-element":25,"virtual-dom/diff":26,"virtual-dom/h":27,"virtual-dom/patch":35,"virtual-dom/virtual-hyperscript/svg":48,"virtual-dom/vnode/vnode":56}],76:[function(require,module,exports){
'use strict';
...
},{"../plugins/css-vars":68,"../plugins/html":70,"../plugins/html-to-vdom":69,"../plugins/router":71,"../plugins/vdom":75,"./weddell":77,"native-promise-only":14}],77:[function(require,module,exports){
'use strict';

module.exports = require('../core/weddell');

},{"../core/weddell":66}],78:[function(require,module,exports){
"use strict";
