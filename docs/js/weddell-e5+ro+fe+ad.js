...
},{"./event-emitter-mixin":20,"./sig":22,"debounce":3,"document-ready-promise":7,"mixwith-es5":12,"object.defaults/immutable":14}],19:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var defaults = require('object.defaults/immutable');
...
},{"../utils/includes":36,"../utils/make-hash":37,"./event-emitter-mixin":20,"./sig":22,"mixwith-es5":12,"object.defaults/immutable":14}],20:[function(require,module,exports){
...
},{"../utils/includes":36,"mixwith-es5":12,"object.defaults/immutable":14}],21:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"./event-emitter-mixin":20,"mixwith-es5":12}],22:[function(require,module,exports){
class Sig {
    constructor(str) {
...
},{"../utils/difference":35,"../utils/includes":36,"../utils/make-hash":37,"./event-emitter-mixin":20,"deep-equal":4,"mixwith-es5":12,"object.defaults/immutable":14}],24:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":36,"./app":18,"./component":19,"./pipeline":21,"./sig":22,"./store":23,"./transform":24,"mixwith-es5":12}],26:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
...
},{"../../core/event-emitter-mixin":20,"mixwith-es5":12}],27:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
...
},{"./action-dispatcher":26,"mixwith-es5":12}],28:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var defaults = require('object.defaults/immutable');
var defaultOpts = {};
...
},{"mixwith-es5":12,"object.defaults/immutable":14}],29:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var mix = require('mixwith-es5').mix;
...
},{"./machine-state-mixin":30,"./router":31,"./state-machine-mixin":32,"mixwith-es5":12}],30:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
var Mixin = require('mixwith-es5').Mixin;
...
},{"../../core/event-emitter-mixin":20,"mixwith-es5":12}],31:[function(require,module,exports){
var defaults = require('object.defaults/immutable');
...
},{"find-parent":8,"object.defaults/immutable":14,"path-to-regexp":16}],32:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../../core/event-emitter-mixin":20,"./machine-state-mixin":30,"mixwith-es5":12}],33:[function(require,module,exports){
...
},{"../plugins/action-dispatcher":27,"../plugins/fetcher":28,"../plugins/router":29,"./weddell":34,"native-promise-only":13}],34:[function(require,module,exports){
module.exports = require('../core/weddell');

},{"../core/weddell":25}],35:[function(require,module,exports){
