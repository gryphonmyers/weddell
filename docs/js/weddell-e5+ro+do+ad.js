...
},{"../utils/difference":36,"../utils/includes":37,"../utils/make-hash":38,"./event-emitter-mixin":21,"deep-equal":4,"mixwith-es5":13,"object.defaults/immutable":15}],25:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"find-parent":9,"object.defaults/immutable":15,"path-to-regexp":17}],33:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../plugins/action-dispatcher":28,"../plugins/doT":29,"../plugins/router":30,"./weddell":35,"native-promise-only":14}],35:[function(require,module,exports){
