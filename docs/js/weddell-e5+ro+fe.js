...
},{"../utils/make-hash":37,"./event-emitter-mixin":22,"./sig":24,"array-compact":1,"array-uniq":4,"mixwith-es5":13,"object.defaults/immutable":15}],22:[function(require,module,exports){
...
},{"../utils/difference":35,"../utils/includes":36,"../utils/make-hash":37,"./event-emitter-mixin":22,"deep-equal":6,"mixwith-es5":13,"object.defaults/immutable":15}],26:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"find-parent":10,"object.defaults/immutable":15,"path-to-regexp":18}],32:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
