...
},{"./event-emitter-mixin":21,"./sig":23,"debounce":3,"document-ready-promise":7,"mixwith-es5":13,"object.defaults/immutable":15}],20:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var defaults = require('object.defaults/immutable');
...
},{"../utils/includes":38,"../utils/make-hash":39,"./event-emitter-mixin":21,"./sig":23,"mixwith-es5":13,"object.defaults/immutable":15}],21:[function(require,module,exports){
...
},{"../utils/includes":38,"mixwith-es5":13,"object.defaults/immutable":15}],22:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"../utils/difference":37,"../utils/includes":38,"../utils/make-hash":39,"./event-emitter-mixin":21,"deep-equal":4,"mixwith-es5":13,"object.defaults/immutable":15}],25:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":38,"./app":19,"./component":20,"./pipeline":22,"./sig":23,"./store":24,"./transform":25,"mixwith-es5":13}],27:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
...
},{"../../core/event-emitter-mixin":21,"mixwith-es5":13}],28:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
...
},{"./action-dispatcher":27,"mixwith-es5":13}],29:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var doT = require('dot');
...
},{"dot":8,"mixwith-es5":13}],30:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var defaults = require('object.defaults/immutable');
var defaultOpts = {};
...
},{"mixwith-es5":13,"object.defaults/immutable":15}],31:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var mix = require('mixwith-es5').mix;
...
},{"./machine-state-mixin":32,"./router":33,"./state-machine-mixin":34,"mixwith-es5":13}],32:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
var Mixin = require('mixwith-es5').Mixin;
...
},{"../../core/event-emitter-mixin":21,"mixwith-es5":13}],33:[function(require,module,exports){
var defaults = require('object.defaults/immutable');
...
},{"find-parent":9,"object.defaults/immutable":15,"path-to-regexp":17}],34:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../../core/event-emitter-mixin":21,"./machine-state-mixin":32,"mixwith-es5":13}],35:[function(require,module,exports){
...
},{"../plugins/action-dispatcher":28,"../plugins/doT":29,"../plugins/fetcher":30,"../plugins/router":31,"./weddell":36,"native-promise-only":14}],36:[function(require,module,exports){
module.exports = require('../core/weddell');

},{"../core/weddell":26}],37:[function(require,module,exports){
