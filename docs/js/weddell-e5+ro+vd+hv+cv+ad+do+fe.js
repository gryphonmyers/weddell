...
},{"./mutable":23,"array-slice":2}],23:[function(require,module,exports){
'use strict';
...
},{"array-each":1,"array-slice":2,"for-own":14,"isobject":19}],24:[function(require,module,exports){
...
},{"browser-split":4}],40:[function(require,module,exports){
...
},{"./event-emitter-mixin":55,"./sig":57,"debounce":5,"document-ready-promise":9,"mixwith-es5":20,"object.defaults/immutable":22}],54:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var defaults = require('object.defaults/immutable');
...
},{"../utils/includes":78,"../utils/make-hash":79,"./event-emitter-mixin":55,"./sig":57,"mixwith-es5":20,"object.defaults/immutable":22}],55:[function(require,module,exports){
...
},{"../utils/includes":78,"mixwith-es5":20,"object.defaults/immutable":22}],56:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"../utils/difference":76,"../utils/includes":78,"../utils/make-hash":79,"./event-emitter-mixin":55,"deep-equal":6,"mixwith-es5":20,"object.defaults/immutable":22}],59:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":78,"./app":53,"./component":54,"./pipeline":56,"./sig":57,"./store":58,"./transform":59,"mixwith-es5":20}],61:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
...
},{"../../core/event-emitter-mixin":55,"mixwith-es5":20}],62:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
...
},{"./action-dispatcher":61,"mixwith-es5":20}],63:[function(require,module,exports){
module.exports = {
...
},{"dot":10,"mixwith-es5":20}],66:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var defaults = require('object.defaults/immutable');
var defaultOpts = {};
...
},{"mixwith-es5":20,"object.defaults/immutable":22}],67:[function(require,module,exports){
...
},{"prescribe":26}],68:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
...
},{"./html-to-vdom-parser":67,"mixwith-es5":20}],69:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var mix = require('mixwith-es5').mix;
...
},{"./machine-state-mixin":70,"./router":71,"./state-machine-mixin":72,"mixwith-es5":20}],70:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
var Mixin = require('mixwith-es5').Mixin;
...
},{"../../core/event-emitter-mixin":55,"mixwith-es5":20}],71:[function(require,module,exports){
var defaults = require('object.defaults/immutable');
...
},{"find-parent":12,"object.defaults/immutable":22,"path-to-regexp":24}],72:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../../core/event-emitter-mixin":55,"./machine-state-mixin":70,"mixwith-es5":20}],73:[function(require,module,exports){
...
},{"../../utils/flatmap":77,"mixwith-es5":20,"object.defaults/immutable":22,"virtual-dom/diff":27,"virtual-dom/h":28,"virtual-dom/patch":29,"virtual-dom/vnode/vnode":47}],74:[function(require,module,exports){
...
},{"../plugins/action-dispatcher":62,"../plugins/css-vars":64,"../plugins/doT":65,"../plugins/fetcher":66,"../plugins/html-to-vdom":68,"../plugins/router":69,"../plugins/vdom":73,"./weddell":75,"native-promise-only":21}],75:[function(require,module,exports){
module.exports = require('../core/weddell');

},{"../core/weddell":60}],76:[function(require,module,exports){
