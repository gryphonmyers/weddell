...
},{"./sig":58,"debounce":7,"document-ready-promise":11,"mixwith-es5":20,"object.defaults/immutable":22}],55:[function(require,module,exports){
...
},{"../utils/make-hash":76,"./event-emitter-mixin":56,"./sig":58,"array-compact":1,"array-uniq":4,"mixwith-es5":20,"object.defaults/immutable":22}],56:[function(require,module,exports){
...
},{"../utils/includes":75,"mixwith-es5":20,"object.defaults/immutable":22}],57:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"../utils/difference":74,"../utils/includes":75,"../utils/make-hash":76,"./event-emitter-mixin":56,"deep-equal":8,"mixwith-es5":20,"object.defaults/immutable":22}],60:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":75,"./app":54,"./component":55,"./pipeline":57,"./sig":58,"./store":59,"./transform":60,"mixwith-es5":20}],62:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var mix = require('mixwith-es5').mix;
var hasMixin = require('mixwith-es5').hasMixin;
var EventEmitterMixin = require('../../core/event-emitter-mixin');

class ActionDispatcher extends mix(ActionDispatcher).with(EventEmitterMixin) {
    constructor(opts) {
        super(opts);
        this._dispatchees = [];
    }
...
},{"find-parent":13,"object.defaults/immutable":22,"path-to-regexp":25}],70:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"mixwith-es5":20,"object.defaults/immutable":22,"virtual-dom/diff":28,"virtual-dom/h":29,"virtual-dom/patch":30,"virtual-dom/vnode/vnode":48}],72:[function(require,module,exports){
...
},{"../plugins/action-dispatcher":62,"../plugins/css-vars":64,"../plugins/html-to-vdom":66,"../plugins/router":67,"../plugins/vdom":71,"./weddell":73,"native-promise-only":21}],73:[function(require,module,exports){
