...
export default function(weddell) {
    ...
    Object.assign(weddell, { 
        createAppClass: function() {
            return class extends createAppClass(...arguments) {
                constructor() {
                    ...
                    this[RENDERERS].vdom = new weddell.VdomHtmlRenderer();
                }
        ...
        createVdomHtmlRendererClass
    });
    
    weddell.setLazyProperty('VdomHtmlRenderer', function () {
        const { Renderer } = this;
        return this.createVdomHtmlRendererClass({ Renderer });
    });
}